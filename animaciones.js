    ...
    skillPack[i].addEventListener('mouseover', ()=>{
        switch (i){
            ...
            case 3:
                ...
                break;
            case 4:
                pSkills.textContent = 'Tengo más de 5 meses trabajando con ASP .NET Core (c#), MVC, ASP Framework, POO, Entities, comunicación con base de datos SQL (Utilizando SQL Server) en la realización de CRUDs.';
                pSkills.style.color = 'purple';
                break;
            case 5:
                pSkills.textContent = 'Experiencia de más de 7 meses con Git para control de versiones, he utilizado Shell, GitKraken, BitBucket y GitHub.';
            ...
            case 6:
                ...
                break;
            case 7:
                pSkills.textContent = 'Más de 7 meses de experiencia en el lenguaje de base de datos relacional SQL, he utilizado Oracle SQL, MySQL y SQL Server para consultas, filtros, envío de datos y actualizaciones de los mismos. Conocimientos sólidos sobre MER.';
